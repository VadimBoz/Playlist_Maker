...
class TrackSearchUseCaseImpl(private val trackRepository: TrackSearchRepository
): TrackSearchUseCase {
    override fun search(query: String): TrackSearchResult {
        if (query.length < 3) {
